Contributing to Frostbyte Core
============================

The Frostbyte Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Frostbyte Core project, and is not to be
confused with overall Frostbyte Network Protocol consensus changes.

Whether a pull request is merged into Frostbyte Core rests with the project merge
...
Patches that change Frostbyte consensus rules are considerably more involved than
...
Where a patch set proposes to change the Frostbyte consensus, it must have been
...
The project leader is the release manager for each Frostbyte Core release.
