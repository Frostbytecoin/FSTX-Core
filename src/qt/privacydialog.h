...
public:
    ...
    void setZFrostbyteControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzFSTX_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzFSTX_clicked();
    void on_pushButtonZFrostbyteControl_clicked();
