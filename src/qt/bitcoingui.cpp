                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Frostbyte Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Frostbyte address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and frostbyte: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Frostbyte Core"), this);
    aboutAction->setStatusTip(tr("Show information about Frostbyte Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Frostbyte"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Frostbyte addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Frostbyte addresses"));
    ...
    openAction->setStatusTip(tr("Open a Frostbyte: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Frostbyte Core help message to get a list with possible Frostbyte command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Frostbyte Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Frostbyte network", "", count));
}
...
{
    QString strTitle = tr("Frostbyte Core"); // default title
...
/** Creates context menu, its actions, and frostbytes up all the relevant signals for mouse events. */
