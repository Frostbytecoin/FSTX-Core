...
/** Utility functions used by the Frostbyte Qt UI.
 */
namespace GUIUtil
{
...
// Render Frostbyte addresses in monospace font
...
// Parse "frostbyte:" URI into recipient object, return true on successful parsing
