...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Frostbyte Core"),
     ...
     * override -datadir in the frostbyte.conf file in the default data directory
     * (to be consistent with frostbyted behavior)
     */
    if (dataDir != getDefaultDataDirectory())
