...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Frostbyte Core frostbyte-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  frostbyte-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded frostbyte transaction") + "\n" +
                               "  frostbyte-tx [options] -create [commands]   " + _("Create hex-encoded frostbyte transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded frostbyte transaction
