...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Frostbyte is not connected
    ...
    RPC_WALLET_PASSFROSTBYTEASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
