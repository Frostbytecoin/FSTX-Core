...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x00000fa2f14092291d5275d6b184ff257f586c31a51a231c1e77554bd837e773"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1543363823, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("042b0655ecdde860009332b011a85a0387685aceb0e42867c28605c71e504f484dece796da678878917b81958ba8f5eb57d9cea9f6360ff42eb49d19864575feb1");
        nDefaultPort = 22211;
        bnProofOfWorkLimit = ~uint256(0) >> 20; //20 Frostbyte starting difficulty is 1 / 2^12
        ...
        nZerocoinStartTime = 1742687239;
        nBlockEnforceSerialRange = 1;
        nBlockRecalculateAccumulators = ~1;
        nBlockFirstFraudulent = ~1;
        nBlockLastGoodCheckpoint = ~1;
        const char* pszTimestamp = "Two roads diverged in a wood, and I took the one less traveled by, and that has made all the difference";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d4b1dd71b4623b875249d5aa0b4480d2774349db72120128b081c54c77ad89c494a15726ce1251924736cde5f05b1e335625d3c0721c3df755eb2be81b4fcf9b") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1543363823;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2942994;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000fa2f14092291d5275d6b184ff257f586c31a51a231c1e77554bd837e773"));
        assert(genesis.hashMerkleRoot == uint256("0x7f3329f933164b7b69f890e25c4be7fb772a03e8e1565c13cc17eac952dd1c9d"));

	vSeeds.push_back(CDNSSeedData("68.183.97.4", "68.183.97.4"));
        vSeeds.push_back(CDNSSeedData("68.183.109.80", "68.183.109.80"));
        vSeeds.push_back(CDNSSeedData("68.183.109.194", "68.183.109.194"));
	...
	strSporkKey = "0428E975298CC19349CEBCC4E6BF40F70C507C93456B750E1F74E9AC1EB4C14BFDB54C7BC1AA7436E939D736E0F3165A8053680D65B6AAB96DBC08DCBC8C6A949E";
        strObfuscationPoolDummyAddress = "F63Q6BR1P7o3dhSJ15m6Cx2eyL6AxFt9hW";
        nStartMasternodePayments = 1543363823;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Frostbyte: 1 day
        nTargetSpacing = 1 * 60;  // Frostbyte: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet frostbyte addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet frostbyte script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet frostbyte BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet frostbyte BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet frostbyte BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Frostbyte: 1 day
        nTargetSpacing = 1 * 60;        // Frostbyte: 1 minutes
