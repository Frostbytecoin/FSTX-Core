...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Frostbyte server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Frostbyte server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Frostbyte features */
        {"frostbyte", "masternode", &masternode, true, true, false},
        {"frostbyte", "listmasternodes", &listmasternodes, true, true, false},
        {"frostbyte", "getmasternodecount", &getmasternodecount, true, true, false},
        {"frostbyte", "masternodeconnect", &masternodeconnect, true, true, false},
        {"frostbyte", "masternodecurrent", &masternodecurrent, true, true, false},
        {"frostbyte", "masternodedebug", &masternodedebug, true, true, false},
        {"frostbyte", "startmasternode", &startmasternode, true, true, false},
        {"frostbyte", "createmasternodekey", &createmasternodekey, true, true, false},
        {"frostbyte", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"frostbyte", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"frostbyte", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"frostbyte", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"frostbyte", "getmasternodescores", &getmasternodescores, true, true, false},
        {"frostbyte", "mnbudget", &mnbudget, true, true, false},
        {"frostbyte", "preparebudget", &preparebudget, true, true, false},
        {"frostbyte", "submitbudget", &submitbudget, true, true, false},
        {"frostbyte", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"frostbyte", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"frostbyte", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"frostbyte", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"frostbyte", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"frostbyte", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"frostbyte", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"frostbyte", "checkbudgets", &checkbudgets, true, true, false},
        {"frostbyte", "mnsync", &mnsync, true, true, false},
        {"frostbyte", "spork", &spork, true, true, false},
        {"frostbyte", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"frostbyte", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use frostbyted, or the -server option to frostbyte-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> frostbyte-cli " + methodname + " " + args + "\n";
}
