...
In order to support loading of multiple wallets in frostbyte-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is frostbyte.cpp.
...
Changes to frostbyte.cpp
----------------------
frostbyte.cpp is the entry point into frostbyte-qt, and as such, will require some minor modifications to provide hooks for
